...
function showRngInfo()
 ...
 if showRngInfoText and mode[index] ~= "None" and mode[index] ~= "100% Catch" and mode[index] ~= "TID Bot" then
  gui.drawBox(0, 124, 108, 159, 0x7F000000, 0x7F000000)
  gui.pixelText(-1, 124, string.format("Initial Seed: %04X", initialSeed))
  gui.pixelText(0, 131, string.format("Battle Video Seed: %08X", battleVideoSeed))
...
function getRngInfoInput()
 ...
 if (mode[index] == "Capture" or mode[index] == "Breeding" or mode[index] == "Pandora" or mode[index] == "Pokemon Info")
     and showRngInfoText
 then
  gui.drawBox(110, 152, 178, 159, 0x7F000000, 0x7F000000)
  gui.pixelText(110, 152, "6 - Hide RNG info")
 elseif (mode[index] == "Capture" or mode[index] == "Breeding" or mode[index] == "Pandora" or mode[index] == "Pokemon Info")
         and not showRngInfoText
 then
  gui.drawBox(110, 152, 178, 159, 0x7F000000, 0x7F000000)
  gui.pixelText(110, 152, "5 - Show RNG info")
 end
end
...
function showDayCareInfo()
 ...
 gui.drawBox(140, 0, 239, 42, 0x7F000000, 0x7F000000)
 ...
 if isEggReady then
  ...
  gui.pixelText(140, 7, "Egg PID:")
  gui.pixelText(176, 7, string.format("%08X%s", eggPID, eggShinyType), eggShinyTypeTextColor)
  gui.pixelText(140, 14, "Nature: "..natureNamesList[eggNatureIndex + 1])
 ...
 gui.pixelText(140, 28, "Timer: "..timer)
 gui.pixelText(140, 35, "Calibration: "..calibration + 1)
end
