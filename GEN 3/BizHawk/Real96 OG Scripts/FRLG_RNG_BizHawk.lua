...
function showEncounterMissingSteps()
 ...
 gui.drawBox(0, 124, 116, 131, 0x7F000000, 0x7F000000)
 gui.pixelText(0, 124, "Steps for wild encounter: "..encounterMissingSteps)
end
...
function showRngInfo()
 ...
 if showRngInfoText and mode[index] ~= "None" and mode[index] ~= "100% Catch" and mode[index] ~= "InitSeed Bot" and mode[index] ~= "TID Bot" then
  ...
  gui.drawBox(0, 138, 88, 159, 0x7F000000, 0x7F000000)
  gui.pixelText(-1, 138, string.format("Initial Seed: %04X", initialSeed))
...
function getRngInfoInput()
 ...
 if (mode[index] == "Capture" or mode[index] == "Breeding" or mode[index] == "Pandora" or mode[index] == "Pokemon Info")
     and showRngInfoText
 then
  gui.drawBox(90, 152, 158, 159, 0x7F000000, 0x7F000000)
  gui.pixelText(90, 152, "6 - Hide RNG info")
 elseif (mode[index] == "Capture" or mode[index] == "Breeding" or mode[index] == "Pandora" or mode[index] == "Pokemon Info")
         and not showRngInfoText
 then
  gui.drawBox(90, 152, 158, 159, 0x7F000000, 0x7F000000)
  gui.pixelText(90, 152, "5 - Show RNG info")
 end
end
...
function getInstructionsInput()
 ...
 elseif mode[index] == "InitSeed Bot" and showInstructionsText then
  gui.pixelText(159, 0, "4 - Hide instructions")
  gui.drawBox(0, 9, 220, 37, 0x7F000000, 0x7F000000)
  gui.pixelText(0, 9, "1) Pause the game")
  gui.pixelText(0, 16, "2) Reset the emulator")
  gui.pixelText(0, 23, "3) Advance a single frame (CTRL+N) while holding SELECT")
  gui.pixelText(0, 30, "4) Unpause the game")
 elseif mode[index] == "TID Bot" and showInstructionsText then
  gui.pixelText(159, 0, "4 - Hide instructions")
  gui.drawBox(0, 9, 216, 44, 0x7F000000, 0x7F000000)
  gui.pixelText(0, 9, "1) Go to name insertion screen")
  gui.pixelText(0, 16, "2) Insert the name you like")
  gui.pixelText(0, 23, "3) Pause the game")
  gui.pixelText(0, 30, "4) Advance a single frame (CTRL+N) while holding START")
  gui.pixelText(0, 37, "5) Unpause the game")
...
function showFoundinitialSeed()
 ...
 if initialSeedFound then
  gui.drawBox(0, 109, 132, 123, 0x7F000000, 0x7F000000)
  gui.pixelText(0, 109, "Found!")
  gui.pixelText(-1, 116, string.format("Initial Seed: %04X", initial))
...
function showFoundTID()
 ...
 if TIDFound then
  gui.drawBox(0, 109, 39, 123, 0x7F000000, 0x7F000000)
  gui.pixelText(0, 109, "Found!")
  gui.pixelText(0, 116, "TID: "..TID)
